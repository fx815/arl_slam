...
MsgConverter::MsgConverter(ros::NodeHandle& nh)
    : nh_(nh)
{
  pose_stamped_subscriber_ = nh_.subscribe("maplab_rovio/T_G_I",1,&MsgConverter::MsgConverterCallback, this);
  transform_stamped_publisher_ = nh_.advertise<geometry_msgs::TransformStamped>("msg_converter/T_G_I", 1);
}
